...
\end{align*}
where $I^\ast$ and $J^\ast$ is defined in \eqref{eq:hott topics1} and \eqref{eq:hott topics}. Therefore, it is possible to learn all potentially most rewarding pairs of rows and columns statistically efficiently. Now we are ready to define our notion of optimality and regret.  Our goal is to minimize the expected $n$-step regret,
\begin{align}
  R(n) =
