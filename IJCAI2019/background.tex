...
\begin{align}
  ...
  \label{eq:regret}
\end{align}
where, the expectation is over any random choice of rows and columns and $i^\ast_t = \argmax_{\{i\in[K], t\in[n]\}}U_t(i,1)$ and  $j^\ast_t = \argmax_{\{j\in[L], t\in[n]\}}V_t(j,1)$.
