...
% \todob{We do not do clicks anymore. The feedback is a non-negative number. You can interpret it as a preference, perhaps rating.} \todob{Look at the appendix to see how to state things more precisely.}
