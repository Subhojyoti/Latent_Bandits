...
\todob{This is where the old analysis starts.}
...
\end{align*}
for $k \in [d]$. Then from the design of our column learning algorithm, for any sequence of users $i_1, \dots, i_n$ and $k \in [d]$,
\begin{align}
...
\todob{This is where the old analysis ends.}
