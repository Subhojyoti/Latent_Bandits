...
%\author{\Large Subhojyoti Mukherjee$^{1}$ \hspace*{3em} \Large Branislav Kveton$^{2}$ \hspace*{3em} \Large Anup B. Rao$^{3}$ \\ \Large ${}^1$University of Massachusetts Amherst \\ \Large ${}^2$Google Research, Mountain View, California, USA \\ \Large${}^3$Adobe Research, San Jose, California, USA}
%\author{AAAI Press\\
